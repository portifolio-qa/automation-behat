...
Feature: [Front] Android Adicionar Status
  ...
  @ITAU-1 @WIP
  Scenario: Verificar Status Em Atualização 
    Dado que capturo o link de "agregador_carteiras" apartir da api status com agencia "3977",conta "0059674",dac "5", cpf "72635654476", segmento "L100" e
